                      ...
                      {course.id === 'web-elevate' && course.betaNote && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                          <div className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 animate-pulse flex-shrink-0" />
                            <div>
                              <p className="text-blue-800 text-sm font-medium mb-1">Beta Program</p>
                              <p className="text-blue-700 text-sm">{course.betaNote}</p>
                            </div>
                          </div>
                        </div>
                      )}
