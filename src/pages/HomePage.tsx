...
const HomePage: React.FC = () => {
  ...
  const { displayText: typingText1, isComplete: typing1Complete } = useTypingEffect(
    "Master Kubernetes, DevOps, and Cloud — not by reading or watching,",
    30,
    heroInView ? 2000 : 0
  );
  const { displayText: typingText2 } = useTypingEffect(
    "but by doing. Real labs. Real projects. Real confidence.",
    30,
    heroInView && typing1Complete ? 500 : 0
  );
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative overflow-hidden py-12 lg:py-16" style={{ backgroundColor: '#FAFAFC' }}>
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            ...
            className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-[#6C63FF] to-[#8B7CF6] rounded-full blur-3xl float-animation"
          />
          <motion.div
            initial={{ opacity: 0, scale: 0 }}
            animate={heroInView ? { opacity: 0.08, scale: 1 } : {}}
            transition={{ duration: 2, delay: 1 }}
            className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-r from-[#8B7CF6] to-[#A855F7] rounded-full blur-2xl float-animation float-delay-1"
          />
          <motion.div
            initial={{ opacity: 0, scale: 0 }}
            animate={heroInView ? { opacity: 0.06, scale: 1 } : {}}
            transition={{ duration: 2, delay: 1.5 }}
            className="absolute bottom-20 left-1/4 w-20 h-20 bg-gradient-to-r from-[#A855F7] to-[#6C63FF] rounded-full blur-2xl float-animation float-delay-2"
          />
        </div>

        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[400px] sm:min-h-[500px]">
            ...
            >
              ...
              <div className="space-y-6 lg:space-y-8">
                <motion.h1
                  ...
                  className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tight"
                ...
                <motion.div
                  ...
                  className="text-lg sm:text-xl lg:text-2xl text-[#4A4A68] leading-relaxed font-medium max-w-2xl mx-auto lg:mx-0"
                  style={{ fontFamily: 'Inter, "Segoe UI", Roboto, sans-serif' }}
                >
                  <div className="block mb-2 min-h-[2rem]">
                    {typingText1}
                    {typing1Complete && <span className="animate-pulse">|</span>}
                  </div>
                  <div className="block min-h-[2rem]">
                    {typingText2 && (
                      <>
                        but by doing. <span className="font-semibold text-[#6C63FF]">{typingText2.replace("but by doing. ", "")}</span>
                      </>
                    )}
                  </div>
                </motion.div>
              ...
              >
                ...
                >
                  <Link
                    ...
                    className="inline-flex items-center justify-center space-x-2 sm:space-x-3 bg-white border-2 border-[#6C63FF] text-[#6C63FF] hover:bg-[#6C63FF] hover:text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-base sm:text-lg transition-all duration-300 shadow-md hover:shadow-xl w-full sm:w-auto relative overflow-hidden"
                    style={{ fontFamily: 'Inter, "Segoe UI", Roboto, sans-serif' }}
                  >
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8 max-w-sm sm:max-w-md mx-auto lg:mx-0">
                {[
                  ...
                  >
                    <div className="w-8 h-8 bg-[#6C63FF]/10 rounded-lg flex items-center justify-center">
                      <stat.icon className="w-4 h-4 text-[#8E8EA0]" />
                    </div>
                    <div>
                      <div className="text-lg font-bold text-slate-900" style={{ fontFamily: 'Inter, "Segoe UI", Roboto, sans-serif' }}>
                        {stat.number}
                      </div>
                      <div className="text-sm text-[#8E8EA0] font-medium" style={{ fontFamily: 'Inter, "Segoe UI", Roboto, sans-serif' }}>
                        {stat.label}
                      </div>
                    </div>
                  </motion.div>
            ...
            >
              {/* Dashboard Mockup */}
              <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 border border-gray-100 max-w-lg mx-auto lg:max-w-none">
                {/* Header */}
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#6C63FF] rounded-lg flex items-center justify-center">
                      <span className="text-white font-bold text-xs sm:text-sm">K</span>
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base" style={{ fontFamily: 'Inter, "Segoe UI", Roboto, sans-serif' }}>
                        Kubernetes Lab
                      </h3>
                ...
                {/* Terminal Content */}
                <div className="bg-gray-900 rounded-lg sm:rounded-xl p-3 sm:p-4 font-mono text-xs sm:text-sm overflow-x-auto">
                  <div className="text-green-400 mb-2">$ kubectl get pods</div>
                  ...
                  <div className="text-green-400 mb-2">$ kubectl apply -f deployment.yaml</div>
      ...
      <section ref={pathsRef} className="py-8 bg-white">
            ...
            {learningPaths.map((path, index) => (
              ...
              >
                {(path.status === 'Live Now' || path.status === 'Beta Version') ? (
                  <Link
                    to={path.path}
                    className="group bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200 p-6 transition-all duration-300 hover:shadow-xl hover:scale-[1.02] block relative overflow-hidden"
                  >
                    {/* Gradient background */}
                    ...
                    <div className="relative">
                      <div className="flex items-start justify-between mb-4">
                        <div className={`w-12 h-12 bg-gradient-to-r ${path.gradient} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                          <path.icon className="w-6 h-6 text-white" />
                        </div>
                        <motion.span
                          className={`px-3 py-1 text-xs font-semibold rounded-full ${path.statusColor}`}
      ...
      <section ref={whyRef} className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Why SAMWI Learn?</h2>
          </motion.div>
            ...
            {whyFeatures.map((feature, index) => (
              ...
              >
                <motion.div
                  ...
                  className={`w-20 h-20 bg-gradient-to-r ${feature.color} rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300`}
                >
      ...
      <section ref={ctaRef} className="py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
        {/* Background pattern */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-12 text-center relative overflow-hidden"
          >
            {/* Decorative elements */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center justify-center space-x-2 bg-slate-50 rounded-xl py-3 px-4"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-6 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-white/80 backdrop-blur-sm"
                      required
                    />
                  </div>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2"
                  >
